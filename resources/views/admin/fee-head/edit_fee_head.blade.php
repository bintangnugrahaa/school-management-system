      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form id="classForm" action="{{ route('fee-head.update') }}" method="post">
              @csrf
              <input type="hidden" name="id" value="{{ $fee_head->id }}">
              <div class="card-body">
                <div class="form-group">
                  <label for="name">Fee Head Name</label>
                  <input type="text" name="name" class="form-control" id="name" placeholder="Enter Class" value="{{ old('name', $fee_head->name) }}">
                </div>
                @error('name')
